...
[![GoDoc](https://godoc.org/github.com/katsucpe/sonargo/sonar?status.svg)](https://godoc.org/github.com/katsucpe/sonargo/sonar)
...
```go
import github.com/katsucpe/sonargo/sonar
```
...
## Notes
- Most code in first release version is generated by code. So some naming is not suitable. See [generate-go-for-sonarqube](https://github.com/katsucpe/generate-go-for-sonarqube)
- Sonarqube community does not build a v7.4 docker image for public, so a v7.4 dockerfile is provided in [build](https://github.com/katsucpe/sonargo/tree/master/build) folder. 
